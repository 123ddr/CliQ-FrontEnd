        ...
        <div className="row">
          <div className="col-6">
            <div className="main-banner position-relative ">
              <img
                src="images/Phantom-4-Pro-V2.0-Top-Camera-Drones.jpg"
        ...
        <div className="row">
          <div className="col-3">
            <div className="famous-card position-relative">
              ...
              <div className="famous-content position-absolute">
                <h5>Lightweight and Foldable Camera Drone with 4K/60fps Video, 48MP Photo</h5>
          ...
          <div className="col-3">
            <div className="famous-card position-relative">
              ...
              <div className="famous-content position-absolute">
                ...
                <h6 className="text-dark">Nikon D3500 DSLR Camera with 18-55mm Lens</h6>
                <p className="text-dark">
                  From $999.00 or $410.62/mo. 
                </p>
              </div>
            </div>
          </div>
          <div className="col-3">
            <div className="famous-card position-relative">
              ...
              />
              <div className="famous-content position-absolute">
                <h5 className="text-dark">Digital High Definition HDV PAL Camcorder</h5>
                <h6 className="text-dark">Sony HVR-HD1000P</h6>
                <p className="text-dark">
                  From $1500 or $116.58/mo. 
                </p>
              </div>
            </div>
          </div>
